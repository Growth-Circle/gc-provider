...
export declare const DEFAULT_MODEL_ID = "gpt-5.6";
export declare const DEFAULT_MODEL_REF = "growthcircle/gpt-5.6";
export declare const DEFAULT_FREE_MODEL_ID = "gpt-5.6-free";
export declare const DEFAULT_FREE_MODEL_REF = "growthcircle/gpt-5.6-free";
...
export declare const FREE_TEXT_MODEL_IDS: readonly ["gpt-5.3-codex-spark", "gpt-5.4", "gpt-5.4-mini", "gpt-5.6", "gpt-5.5", "claude-haiku-4-5-20251001", "claude-opus-4-6", "claude-opus-4-7", "claude-sonnet-4-6", "deepseek-v4-flash", "deepseek-v4-pro", "gemini-2.5-flash", "gemini-2.5-flash-lite", "gemini-2.5-pro", "gemini-3-flash-preview", "gemini-3-pro-preview", "gemini-3.1-pro-preview", "MiniMax-M2.7", "MiniMax-M3", "MiniMax-M2.7-highspeed", "mimo-v2.5", "mimo-v2.5-pro", "laguna-s-2.1", "qwen3.7-flash", "gpt-5.6-luna", "muse-spark-1.2-contributor", "step-3.5-flash", "hy3"];
export declare const PAID_TEXT_MODEL_IDS: readonly ["gpt-5.3-codex-spark", "gpt-5.4", "gpt-5.4-mini", "gpt-5.6", "gpt-5.5", "claude-3-5-haiku-latest", "claude-fable-5", "claude-haiku-4-5-20251001", "claude-haiku-4-5-20251001-thinking", "claude-opus-4-5-20251101", "claude-opus-4-5-20251101-thinking", "claude-opus-4-6", "claude-opus-4-6-thinking", "claude-opus-4-7", "claude-opus-4-8", "claude-opus-5", "claude-sonnet-4-5-20250929", "claude-sonnet-4-5-20250929-thinking", "claude-sonnet-4-6", "claude-sonnet-4-6-thinking", "claude-sonnet-5", "deepseek-ocr", "deepseek-r1", "deepseek-r1-0528", "deepseek-r1-250528", "deepseek-v3", "deepseek-v3-0324", "deepseek-v3.1", "deepseek-v3.1-terminus", "deepseek-v3.2", "deepseek-v3.2-exp", "deepseek-v3.2-think", "deepseek-v4-flash", "deepseek-v4-pro", "gemini-2.0-flash", "gemini-2.5-flash", "gemini-2.5-flash-nothinking", "gemini-2.5-flash-thinking", "gemini-2.5-flash-lite", "gemini-2.5-pro", "gemini-2.5-pro-nothinking", "gemini-2.5-pro-thinking", "gemini-3-flash-preview", "gemini-3-flash-preview-nothinking", "gemini-3-flash-preview-thinking", "gemini-3-pro-preview", "gemini-3-pro-preview-thinking", "gemini-3.1-flash-lite-preview", "gemini-3.1-pro-preview", "gemini-3.1-pro-preview-thinking", "gemini-3.5-flash", "gemini-3.5-flash-lite", "gemini-omni-flash-preview", "glm-4.6", "glm-4.7", "glm-5", "glm-5.1", "glm-5.2", "kimi-k2-instruct", "kimi-k2-thinking", "kimi-k2.5", "MiniMax-M2.7", "MiniMax-M3", "MiniMax-M2.7-highspeed", "qwen3.7-flash", "gpt-5.6-luna", "muse-spark-1.2-contributor", "step-3.5-flash", "mimo-v2.5", "hy3"];
export declare const TEAM_TEXT_MODEL_IDS: readonly ["gpt-5.3-codex-spark", "gpt-5.4", "gpt-5.4-mini", "gpt-5.6", "gpt-5.5"];
...
export declare const KNOWN_TEXT_MODEL_IDS: ("gpt-5.6" | "gpt-5.5" | "gpt-5.3-codex-spark" | "gpt-5.4" | "gpt-5.4-mini" | "claude-haiku-4-5-20251001" | "claude-opus-4-6" | "claude-opus-4-7" | "claude-sonnet-4-6" | "deepseek-v4-flash" | "deepseek-v4-pro" | "gemini-2.5-flash" | "gemini-2.5-flash-lite" | "gemini-2.5-pro" | "gemini-3-flash-preview" | "gemini-3-pro-preview" | "gemini-3.1-pro-preview" | "MiniMax-M2.7" | "MiniMax-M3" | "MiniMax-M2.7-highspeed" | "mimo-v2.5" | "mimo-v2.5-pro" | "laguna-s-2.1" | "qwen3.7-flash" | "gpt-5.6-luna" | "muse-spark-1.2-contributor" | "step-3.5-flash" | "hy3" | "claude-3-5-haiku-latest" | "claude-fable-5" | "claude-haiku-4-5-20251001-thinking" | "claude-opus-4-5-20251101" | "claude-opus-4-5-20251101-thinking" | "claude-opus-4-6-thinking" | "claude-opus-4-8" | "claude-opus-5" | "claude-sonnet-4-5-20250929" | "claude-sonnet-4-5-20250929-thinking" | "claude-sonnet-4-6-thinking" | "claude-sonnet-5" | "deepseek-ocr" | "deepseek-r1" | "deepseek-r1-0528" | "deepseek-r1-250528" | "deepseek-v3" | "deepseek-v3-0324" | "deepseek-v3.1" | "deepseek-v3.1-terminus" | "deepseek-v3.2" | "deepseek-v3.2-exp" | "deepseek-v3.2-think" | "gemini-2.0-flash" | "gemini-2.5-flash-nothinking" | "gemini-2.5-flash-thinking" | "gemini-2.5-pro-nothinking" | "gemini-2.5-pro-thinking" | "gemini-3-flash-preview-nothinking" | "gemini-3-flash-preview-thinking" | "gemini-3-pro-preview-thinking" | "gemini-3.1-flash-lite-preview" | "gemini-3.1-pro-preview-thinking" | "gemini-3.5-flash" | "gemini-3.5-flash-lite" | "gemini-omni-flash-preview" | "glm-4.6" | "glm-4.7" | "glm-5" | "glm-5.1" | "glm-5.2" | "kimi-k2-instruct" | "kimi-k2-thinking" | "kimi-k2.5")[];
