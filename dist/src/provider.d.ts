...
export declare const FREE_TEXT_MODEL_IDS: readonly ["gpt-5.3-codex", "gpt-5.4", "gpt-5.4-mini", "gpt-5.6", "gpt-5.5", "claude-haiku-4-5-20251001", "claude-opus-4-6", "claude-opus-4-7", "claude-sonnet-4-6", "deepseek-v4-flash", "deepseek-v4-pro", "gemini-2.5-flash", "gemini-2.5-flash-lite", "gemini-2.5-pro", "gemini-3-flash-preview", "gemini-3-pro-preview", "gemini-3.1-pro-preview", "MiniMax-M2.7", "MiniMax-M3", "MiniMax-M2.7-highspeed"];
export declare const PAID_TEXT_MODEL_IDS: readonly ["gpt-5.3-codex", "gpt-5.3-codex-spark", "gpt-5.4", "gpt-5.4-mini", "gpt-5.6", "gpt-5.5", "claude-3-5-haiku-latest", "claude-haiku-4-5-20251001", "claude-haiku-4-5-20251001-thinking", "claude-opus-4-5-20251101", "claude-opus-4-5-20251101-thinking", "claude-opus-4-6", "claude-opus-4-6-thinking", "claude-opus-4-7", "claude-sonnet-4-5-20250929", "claude-sonnet-4-5-20250929-thinking", "claude-sonnet-4-6", "claude-sonnet-4-6-thinking", "deepseek-ocr", "deepseek-r1-0528", "deepseek-r1-250528", "deepseek-v3-0324", "deepseek-v3.1-terminus", "deepseek-v3.2", "deepseek-v3.2-exp", "deepseek-v4-flash", "deepseek-v4-pro", "gemini-2.0-flash", "gemini-2.5-flash", "gemini-2.5-flash-nothinking", "gemini-2.5-flash-thinking", "gemini-2.5-flash-lite", "gemini-2.5-pro", "gemini-2.5-pro-nothinking", "gemini-2.5-pro-thinking", "gemini-3-flash-preview", "gemini-3-flash-preview-nothinking", "gemini-3-flash-preview-thinking", "gemini-3-pro-preview", "gemini-3-pro-preview-thinking", "gemini-3.1-flash-lite-preview", "gemini-3.1-pro-preview", "gemini-3.1-pro-preview-thinking", "gemini-3.5-flash", "glm-4.6", "glm-4.7", "glm-5", "glm-5.1", "kimi-k2-instruct", "kimi-k2-thinking", "kimi-k2.5", "MiniMax-M2.7", "MiniMax-M3", "MiniMax-M2.7-highspeed"];
export declare const TEAM_TEXT_MODEL_IDS: readonly ["gpt-5.3-codex", "gpt-5.3-codex-spark", "gpt-5.4", "gpt-5.4-mini", "gpt-5.6", "gpt-5.5"];
...
export declare const KNOWN_TEXT_MODEL_IDS: ("gpt-5.6" | "gpt-5.5" | "gpt-5.3-codex" | "gpt-5.4" | "gpt-5.4-mini" | "claude-haiku-4-5-20251001" | "claude-opus-4-6" | "claude-opus-4-7" | "claude-sonnet-4-6" | "deepseek-v4-flash" | "deepseek-v4-pro" | "gemini-2.5-flash" | "gemini-2.5-flash-lite" | "gemini-2.5-pro" | "gemini-3-flash-preview" | "gemini-3-pro-preview" | "gemini-3.1-pro-preview" | "MiniMax-M2.7" | "MiniMax-M3" | "MiniMax-M2.7-highspeed" | "gpt-5.3-codex-spark" | "claude-3-5-haiku-latest" | "claude-haiku-4-5-20251001-thinking" | "claude-opus-4-5-20251101" | "claude-opus-4-5-20251101-thinking" | "claude-opus-4-6-thinking" | "claude-sonnet-4-5-20250929" | "claude-sonnet-4-5-20250929-thinking" | "claude-sonnet-4-6-thinking" | "deepseek-ocr" | "deepseek-r1-0528" | "deepseek-r1-250528" | "deepseek-v3-0324" | "deepseek-v3.1-terminus" | "deepseek-v3.2" | "deepseek-v3.2-exp" | "gemini-2.0-flash" | "gemini-2.5-flash-nothinking" | "gemini-2.5-flash-thinking" | "gemini-2.5-pro-nothinking" | "gemini-2.5-pro-thinking" | "gemini-3-flash-preview-nothinking" | "gemini-3-flash-preview-thinking" | "gemini-3-pro-preview-thinking" | "gemini-3.1-flash-lite-preview" | "gemini-3.1-pro-preview-thinking" | "gemini-3.5-flash" | "glm-4.6" | "glm-4.7" | "glm-5" | "glm-5.1" | "kimi-k2-instruct" | "kimi-k2-thinking" | "kimi-k2.5")[];
